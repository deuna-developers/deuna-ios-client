//
// GetUserCards200ResponseDataInner.swift
//
...
public struct GetUserCards200ResponseDataInner: Codable, JSONEncodable, Hashable {
    ...
    public init(cardHolder: String? = nil, cardHolderDni: String? = nil, company: String? = nil, deletedAt: String? = nil, expirationDate: String? = nil, firstSix: String? = nil, id: String? = nil, isValid: Bool? = nil, lastFour: String? = nil, token: String? = nil, verifiedAt: String? = nil, verifiedBy: String? = nil) {
