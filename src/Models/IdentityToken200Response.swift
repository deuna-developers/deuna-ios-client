//
// IdentityToken200Response.swift
//
...
public struct IdentityToken200Response: Codable, JSONEncodable, Hashable {
    ...
    public var merchantEvents: [IdentityToken200ResponseMerchantEventsInner]?
    ...
    public init(createdAt: String? = nil, deletedAt: String? = nil, ID: String? = nil, updatedAt: String? = nil, accountNumber: String? = nil, accountType: String? = nil, amplitudeId: String? = nil, apiKey: String? = nil, autoApproveOrderInCore: Bool? = nil, bankName: String? = nil, businessUrl: String? = nil, city: String? = nil, country: String? = nil, currency: String? = nil, domain: String? = nil, gtmId: String? = nil, industry: String? = nil, logo: String? = nil, managedByDuna: Bool? = nil, merchantCategoryCode: String? = nil, merchantEvents: [IdentityToken200ResponseMerchantEventsInner]? = nil, name: String? = nil, onboardingStep: Int? = nil, orderApiPort: Int? = nil, orderApiUrl: String? = nil, orderPickupApiUrl: String? = nil, pickupTokenUrl: String? = nil, platform: String? = nil, policies: [String]? = nil, privacyPoliciesUrl: String? = nil, service: String? = nil, shortName: String? = nil, statusChangesNotificationUrl: String? = nil, storefrontBaseUrl: String? = nil, storefrontPrivateUrl: String? = nil, termAndConditionsUrl: String? = nil, timezone: String? = nil, token: String? = nil, useDunaSend: Bool? = nil, vendorId: String? = nil) {
