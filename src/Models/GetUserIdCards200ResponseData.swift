//
// GetUserIdCards200ResponseData.swift
//
...
public struct GetUserIdCards200ResponseData: Codable, JSONEncodable, Hashable {
    ...
    public init(cardHolder: String? = nil, cardHolderDni: String? = nil, company: String? = nil, createdAt: String? = nil, deletedAt: String? = nil, expirationDate: String? = nil, firstSix: String? = nil, id: String? = nil, lastFour: String? = nil, updatedAt: String? = nil, userId: String? = nil) {
