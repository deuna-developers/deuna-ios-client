...
public struct GetOrder200ResponseOrder: Codable, JSONEncodable, Hashable {
    ...
    public var shippingOptions: GetOrder200ResponseOrderShippingOptions?
    /** Es el monto total de los **impuestos** del envío aplicados en la orden que aparece en el checkout. */
    public var shippingTaxAmount: Int64?
    /** Estado de la orden  */
    ...
    public var totalTaxAmount: Int64?
    ...
    public init(billingAddress: OrderToken200ResponseOrderBillingAddress? = nil, cashChange: Double? = nil, currency: String? = nil, discounts: Set<OrderToken200ResponseOrderDiscountsInner>? = nil, displayItemsTotalAmount: String? = nil, displayShippingAmount: String? = nil, displayShippingTaxAmount: String? = nil, displaySubTotal: String? = nil, displayTaxAmount: String? = nil, displayTotalAmount: String? = nil, displayTotalDiscount: String? = nil, displayTotalTaxAmount: String? = nil, giftCard: [OrderTokenRequestOrderGiftCardInner]? = nil, items: [OrderToken200ResponseOrderItemsInner]? = nil, itemsTotalAmount: Double? = nil, metadata: OrderToken200ResponseOrderMetadata? = nil, orderId: String? = nil, payment: OrderTokenRequestOrderPayment? = nil, paymentLink: String? = nil, redirectUrl: String? = nil, scheduledAt: String? = nil, shipping: OrderToken200ResponseOrderShipping? = nil, shippingAddress: OrderTokenRequestOrderShippingAddress? = nil, shippingAmount: Double? = nil, shippingMethod: OrderTokenRequestOrderShippingMethod? = nil, shippingMethods: [AnyCodable]? = nil, shippingOptions: GetOrder200ResponseOrderShippingOptions? = nil, shippingTaxAmount: Int64? = nil, status: Status? = nil, storeCode: String? = nil, subTotal: Double? = 4470, taxAmount: Double? = nil, timezone: String? = nil, totalAmount: Double? = nil, totalDiscount: Double? = nil, totalTaxAmount: Int64? = nil, userInstructions: String? = nil) {
