//
// OrderTokenRequestOrderShippingAddress.swift
//
...
public struct OrderTokenRequestOrderShippingAddress: Codable, JSONEncodable, Hashable {
    ...
    public init(additionalDescription: String? = nil, address1: String? = nil, address2: String? = nil, addressType: AddressType? = nil, city: String? = nil, country: Country? = nil, createdAt: String? = nil, firstName: String? = nil, id: Double? = nil, identityDocument: String? = nil, isDefault: Bool? = false, lastName: String? = nil, lat: Double? = nil, lng: Double? = nil, phone: String? = nil, stateName: String? = nil, updatedAt: String? = nil, userId: String? = nil, zipcode: String? = nil) {
