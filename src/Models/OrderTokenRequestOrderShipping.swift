//
// OrderTokenRequestOrderShipping.swift
//
...
/** Tarifa de envío */
public struct OrderTokenRequestOrderShipping: Codable, JSONEncodable, Hashable {
    ...
    public init(discounts: Set<OrderTokenRequestOrderItemsInnerDiscountsInner>? = nil, originalAmount: Double? = nil, totalDiscount: Double? = nil) {
