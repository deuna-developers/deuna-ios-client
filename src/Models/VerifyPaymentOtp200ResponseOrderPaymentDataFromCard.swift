//
// VerifyPaymentOtp200ResponseOrderPaymentDataFromCard.swift
//
...
public struct VerifyPaymentOtp200ResponseOrderPaymentDataFromCard: Codable, JSONEncodable, Hashable {
